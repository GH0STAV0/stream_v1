...
KEY="qm7u-7k3u-42jm-xedt-3q9p" &&

ffmpeg -re -i xx.mp4 -c:v libx264 -b:v 750k -c:a copy -strict -2 -flags +global_header -bsf:a aac_adtstoasc -bufsize 2100k -f flv rtmp://a.rtmp.youtube.com/live2/$KE
